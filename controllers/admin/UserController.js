...
exports.getAllUsers = async (req, res) => {
  ...
  exports.insertUser = async (req, res) => {
    ...
    const { first_name, last_name, email, gender, about } = req.body;
    ...
    try {
      ...
      if(user.length === 0)
      {
        ...
        const sql = "INSERT INTO `users` SET first_name=?, last_name=?, email=?, password=?, gender=?, about=?, profile_img=?, status='?'";
        const results = await db.query(sql, [first_name, last_name, email, hashedPassword, gender, about, profile_img, status]);
  ...
  exports.updateUser = async (req, res) => {
    ...
    const { id, first_name, last_name, email, gender, about } = req.body;
    ...
    try {
      ...
      if(user.length > 0)
      {
        ...
        const sql = 'UPDATE `users` SET first_name=?, last_name=?, email=?, gender=?, about=?, profile_img=? WHERE id=?';
        const edit_results = await db.query(sql, [first_name, last_name, email, gender, about, profile_img, id]);
